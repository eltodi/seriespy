...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('series_mensaje', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('remitente', self.gf('django.db.models.fields.related.ForeignKey')(related_name='remitente_mensaje_set', to=orm['auth.User'])),
            ('destinatario', self.gf('django.db.models.fields.related.ForeignKey')(related_name='destinatario_mensaje_set', to=orm['auth.User'])),
            ('fecha', self.gf('django.db.models.fields.DateTimeField')()),
            ('visto', self.gf('django.db.models.fields.DateTimeField')()),
            ('texto', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('series', ['Mensaje'])


    def backwards(self, orm):
        # Deleting model 'Mensaje'
        db.delete_table('series_mensaje')
    ...
    models = {
        ...
        'series.episodiousuario': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notificar_descarga': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'series.mensaje': {
            ...
            'destinatario': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'destinatario_mensaje_set'", 'to': "orm['auth.User']"}),
            'fecha': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'remitente': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'remitente_mensaje_set'", 'to': "orm['auth.User']"}),
            'texto': ('django.db.models.fields.DateTimeField', [], {}),
            'visto': ('django.db.models.fields.DateTimeField', [], {})
        },
        'series.perfilusuario': {
            'Meta': {'object_name': 'PerfilUsuario'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notificaciones_activas': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
