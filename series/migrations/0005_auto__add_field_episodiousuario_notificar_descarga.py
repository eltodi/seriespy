...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EpisodioUsuario.notificar_descarga'
        db.add_column('series_episodiousuario', 'notificar_descarga',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EpisodioUsuario.notificar_descarga'
        db.delete_column('series_episodiousuario', 'notificar_descarga')
