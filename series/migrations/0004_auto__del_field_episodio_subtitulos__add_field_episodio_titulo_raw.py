...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Episodio.subtitulos'
        db.delete_column('series_episodio', 'subtitulos')

        # Adding field 'Episodio.titulo_raw'
        db.add_column('series_episodio', 'titulo_raw',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Episodio.subtitulos'
        db.add_column('series_episodio', 'subtitulos',
                      self.gf('django.db.models.fields.files.FileField')(default=0, max_length=100),
                      keep_default=False)

        # Deleting field 'Episodio.titulo_raw'
        db.delete_column('series_episodio', 'titulo_raw')
