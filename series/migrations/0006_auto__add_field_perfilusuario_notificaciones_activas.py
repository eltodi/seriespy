...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PerfilUsuario.notificaciones_activas'
        db.add_column('series_perfilusuario', 'notificaciones_activas',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PerfilUsuario.notificaciones_activas'
        db.delete_column('series_perfilusuario', 'notificaciones_activas')
